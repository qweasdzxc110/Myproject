function Safer_prediction = SAFER_f(DataStruct,k)
...
% load('housing10.mat');
label = DataStruct.GroundTruth(DataStruct.LabeledIndex);
ground_truth = DataStruct.GroundTruth(DataStruct.UnlabeledIndex);
label_instance = DataStruct.data(DataStruct.LabeledIndex);
unlabel_instance = DataStruct.data(DataStruct.UnlabeledIndex);
...
prediction1 = Self_KNN(label_instance,unlabel_instance,label,'euclidean',k);
prediction2 = Self_KNN(label_instance,unlabel_instance,label,'cosine',k);
